...
void interrogate_network_button_func(void)
{
	...
	interrogate_network(in_silico_network);
	printf ("learning_rate: %f\n", reward_data.learning_rate);
} 		

void interrogate_neuron_button_func(void)
{
	interrogate_neuron	(in_silico_network, gtk_combo_box_get_active (GTK_COMBO_BOX(combos_select_neuron->combo_layer)), gtk_combo_box_get_active (GTK_COMBO_BOX(combos_select_neuron->combo_neuron_group)), gtk_combo_box_get_active (GTK_COMBO_BOX(combos_select_neuron->combo_neuron)) );
}
...
static void make_output_button_func(void)
{
	...
	set_layer_type_of_the_neurons_in_layer(in_silico_network, layer_num, NEURON_LAYER_TYPE_OUTPUT);
...
static void create_default_network_button_func(void)
{
	...
	if (! connect_superfluous_neurons()) {
		print_message(ERROR_MSG ,"HybridNetwork", "HybridNetwork", "main", "! connect_superfluous_neurons().");return; }
