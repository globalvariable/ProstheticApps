...
#define MINIMUM_IN_SILICO_TO_IN_SILICO_AXONAL_DELAY SNN_SIM_PERIOD + 1000000    /// 1 ms buffer for jitters
...
#define MINIMUM_BLUE_SPIKE_TO_IN_SILICO_AXONAL_DELAY BLUESPIKE_DAQ_PERIOD+(SPIKE_MIN_END_SAMP_NUM*SAMPLING_INTERVAL)+SNN_SIM_PERIOD+1000000	 /// 1 ms buffer for jitters
